...
I18N.zh = {
    ...
    "pubilc": { // 公共區域翻譯
        ...
        "regexp": [ // 正則翻譯 (公共區域正則會二次呼叫翻譯，為了彌補部分翻譯的情況)
            /**
             * 匹配時間格式
             *
    ...
    "page-profile": { // 個人首頁
        "static": { // 靜態翻譯
            "Updating your profile with your name, location, and a profile picture helps other GitHub users get to know you.": "更新您的資料訊息包括姓名，地址，大頭貼等資料，讓其他使用者更容易的了解您。",
            ...
            "You can now pin up to 6 repositories.": "你現在可以設定6個固定倉庫。",
    ...
    "page-account": { // 個人設定
        "static": { // 靜態翻譯
            ...
            "Delete account": "刪除帳戶",
            "Once you delete your account, there is no going back. Please be certain.": "一旦您刪除了帳戶，就沒辦法復原，請三思而行。",
            ...
            "We will use": "我們將使用",
            "when performing web-based Git operations and sending email on your behalf. If you want command line Git operations to use your private email you must": "作為預設\"發件人\"地址以您的名義發送電子郵件。如果您想在指令行 Git 的操作中使用您的私人郵件地址，您必須在",
            ...
            "Your notification settings apply to the": "通知設定將套用到",
            ...
            "Sessions": "工作階段訊息",
            "This is a list of devices that have logged into your account. Revoke any sessions that you do not recognize.": "這是您登入的裝置工作階段列表，如果不是您本人操作，可以關閉該工作階段。",
            ...
            // Applications 選單
            "Authorized applications": "已授權的程式",
            "Developer applications": "開發者程式",
            "Revoke all": "註銷全部",
            ...
            "No Developer Applications": "暫無開發者的程式",
            "Developer applications are used to access the": "開發者程式是用於訪問",
            ". To get started you should": "。首先您應該",
            "register an application": "註冊一個程式",
            "Register new application": "註冊程式",
            "Register a new OAuth application": "註冊一個 OAuth 程式",
            "Application name": "程式名",
            "Something users will recognize and trust": "讓使用者識別和信任",
            "Homepage URL": "首頁地址",
            "The full URL to your application homepage": "您的程式首頁地址",
            "Application description": "程式描述",
            "Application description is optional": "程式描述 (可選)",
            "This is displayed to all potential users of your application": "給您的目標使用者最直接的訊息",
            "Authorization callback URL": "認證回調地址",
            "Your application’s callback URL. Read our": "您的程式授權回調地址。詳情請閱讀",
            "OAuth documentation": "OAuth 文件",
            "for more information": "。",
            "Register application": "註冊程式",
            "Drag & drop": "拖曳上傳",
            "or": "或者",
            ...
            "authenticate to the API over Basic Authentication": "或用來進行API呼叫的驗證",
        ...
        "regexp": [ // 正則翻譯
            ...
            [/Using\n\s+([\d.]+) of\n\s+(\d+) GB/, "＄$1, $2GB"],
            [/(\d+) Authorized applications?/, "$1 個授權程式"],
    ...
    "new/import": { // 匯入倉庫
        "static": { // 靜態翻譯
            ...
            "Import all the files, including the revision history, from another version control system.": "匯入的所有文件，包括修訂歷史記錄，從另一個版本控制系統。",
    ...
    "vis-public": { // 倉庫頁
        "static": { // 靜態翻譯
            ...
            "You can now drag and drop files into your repositories.": "您可以直接拖曳文件到該倉庫介面進行上傳。",
            "Learn more": "查看詳情",
            "Dismiss": "我知道了",
            ...
            "or view": "打開，或透過",
            "command line instructions": "指令行查看",
            ...
            "Rename": "重新命名",
            "Features": "特性",
            "GitHub Wikis is a simple way to let others contribute content. Any GitHub user can create and edit pages to use for documentation, examples, support, or anything you wish.": "GitHub Wikis 是一個簡單的方法讓別人貢獻內容。GitHub 的任何使用者都可以建立和編輯頁面中使用的文件，範例，支援或任何您想。",
            ...
            "Add all commits from the head branch to the base branch with a merge commit.": "從head分支的所有提交合並提交到base分支。",
            ...
            "— Unavailable for your site because you have a custom domain configured (": "- 無法為您的網站開啟，因為您設定了一個自訂域名 (",
            ...
            "Public forks can’t be made private. Please": "衍生的的倉庫，無法轉為私有，請",
            ...
            "Default branch": "預設分支",
            "The default branch is considered the “base” branch in your repository, against which all pull requests and code commits are automatically made, unless you specify a different branch.": "預設分支被認為是“基地”分支在您的資料庫，對所有拉取請求和程式碼的提交是自動進行的，除非您指定一個不同的分支。",
            "Update": "更新",
            ...
            ", and": "，和",
            "…or create a new repository on the command line": "…或在指令行上建立一個新的倉庫",
            ...
            "Attach binaries by dropping them here or": "拖曳文件到這來添加附件",
    ...
    "homepage": { // 未登入首頁
        "static": { // 靜態翻譯
            ...
            "Millions of developers use GitHub to build personal projects, support their businesses, and work together on open source technologies.": "數以百萬計的開發人員使用 GitHub 建立個人項目，支持他們的企業，共同在開放原始碼技術。",
    ...
    "oauth": { // 程式授權
        "static": { // 靜態翻譯
            ...
            "This application will be able to identify you and read public information.": "此程式程式將能識別您的身份和讀取您的公共訊息。",
            "Learn more": "更多",

            "Visit application’s website": "訪問程式官網",
